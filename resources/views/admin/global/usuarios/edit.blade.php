...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto bg-white rounded-lg shadow-lg border-2 border-gray-500 overflow-hidden">
        ...
        @endif
        <form action="{{ route('usuarios.update', $usuario->id_usuario) }}" method="POST" class="p-6 space-y-4">
            @csrf
            @method('PUT')
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="password" name="password" id="password" class="w-full px-4 py-3 border-2 border-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-700">
            </div>
            ...
            <div class="mb-4">
                ...
                <select name="id_centro" id="id_centro" class="w-full px-4 py-3 border-2 border-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-700">
            ...
            <div class="flex justify-end items-center space-x-3">
                <button type="submit" class="px-5 py-3 bg-gray-300 text-gray-700 rounded-lg border-2 border-gray-500 hover:bg-gray-400">Actualizar</button>
                <a href="{{ route('usuarios.index') }}" class="px-5 py-3 bg-gray-300 text-gray-700 rounded-lg border-2 border-gray-500 hover:bg-gray-400">Cancelar</a>
            </div>
        </form>
    </div>
@endsection