...
<div class="form-container">
    <div class="form-card">
        <h2 class="form-title">Registrar Nueva Consulta</h2>

        <form action="{{ route('consultas.store', $historial->id_historial) }}" method="POST">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea name="motivo_consulta" id="motivo_consulta" rows="3" required></textarea>
            </div>

            <div class="form-group">
                <label for="sintomas">Síntomas:</label>
                <textarea name="sintomas" id="sintomas" rows="3" required></textarea>
            </div>
